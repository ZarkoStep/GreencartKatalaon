...
WebUI.setText(findTestObject('Object Repository/Page_GreenKart - Search item/input_KART_search-keyword'), 'car')

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_GreenKart - Search item/My cart img'))
