...
WebUI.setText(findTestObject('Page_GreenKart - Search item/input_KART_search-keyword'), InvalidSearch)
...
WebUI.getText(findTestObject('Page_GreenKart - Search item/No object meched your search'))
